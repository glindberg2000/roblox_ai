...
def create_problem_doc():
    ...
    base_doc = read_file('docs/npc_edit_form_issue.md')
    ...
    # Write to file
    with open('docs/npc_edit_form_issue_complete.md', 'w', encoding='utf-8') as f:
        f.write(complete_doc)

if __name__ == "__main__":
    create_problem_doc()
    print("Generated npc_edit_form_issue_complete.md") 