return {
    assets = {
        ...
        },
        {
            assetId = "13292405039",
            name = "Road Sign Stop",
            description = "An iconic americana-style street accessory features a classic stop sign, characterized by an octagonal red sign mounted on a simple gray pole. The word STOP is prominently displayed in bold, white capital letters across the center. The design is minimalistic, reflecting typical traffic signage, suitable for various game environments.",
        },
        {
            assetId = "2690222444",
