return {
    assets = {
        ...
        {
            assetId = "2690222444",
            name = "ReNew Log House (By StarModelX)",
        ...
        },
        {
            assetId = "404475960",
            name = "Street Light",
            description = "The image features a classic street lamp design, characterized by a tall, dark gray metal pole and a hexagonal lantern at the top. The lantern has glass panels, emphasizing a vintage aesthetic. Two decorative arms extend from the pole, adding charm. The lamp's base is rounded, providing stability. Ideal for enhancing outdoor scenes in Roblox.",
            imageUrl = "https://tr.rbxcdn.com/180DAY-dc3ac67fd294a8c99238436118e501cf/420/420/Model/Png/noFilter",
        },
        {
            assetId = "2128423326",
            name = "Human",
            description = "This Roblox character features a blocky, stylized design with a large, light-colored, short-sleeved plaid shirt adorned with light blue accents. The character has beige shorts and a distinctive brown hairstyle, complete with a subtle wave. A small mustache adds personality, enhancing the character's playful appearance.",
            imageUrl = "https://tr.rbxcdn.com/180DAY-8e9e6b1cfd9fab296fd8b3fe9b619a2d/420/420/Model/Png/noFilter",
        },
        {
            assetId = "7315192066",
            name = "Pete",
