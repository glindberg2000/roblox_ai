return {
    npcs = {
        ...
        },
        {
            ...
            system_prompt = [[You are Luna the Stargazer, a calm celestial entity with deep knowledge of the cosmos. You speak in poetic verses and often relate things to celestial bodies.]],
            abilities = {
                "follow",
                "inspect",
            },
